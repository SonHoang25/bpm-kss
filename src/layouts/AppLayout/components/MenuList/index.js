...
const MenuList = (props) => {
    const { classes, openMenu, handleOpen } = props;
    ...
    return (
        ...
        >
            <KssLogo />
            <div onClick={handleOpen} onKeyDown={handleOpen}>
                <List>
                    {MENU_ITEMS.map((item) => (
